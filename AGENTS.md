...
> 最后更新：2026-06-01（Website Ads Launch Prep P29.ADS.1 已完成，下一步是 optional ads landing page）

| 任务 ID | 内容 | 优先级 |
|---------|------|--------|
| **P29.ADS.2** | Optional ads landing page：如果投放跑顺，再补一个独立 `/ads` landing page；当前先保持 contact flow 轻量 | ⭐⭐ |

**状态校准（2026-06-01）**：P29.SEO.9 已完成，P29.ADS.1 已完成；下一步转向 optional ads landing page。下一 session 第一句话：
