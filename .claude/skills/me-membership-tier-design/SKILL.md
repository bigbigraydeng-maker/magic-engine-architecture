...
description: 唤起"ME 会员体系重新设计"多轮 PM 对话——续聊免费 / $39 / $199 / $499 / 定制五档的服务内容、定价、6 大支柱怎么分布。别名"张居正"（明朝以"一条鞭法"化繁为简统一税制的首辅，对应这次"把复杂分档简化成清晰规则"的设计工作）。触发场景：用户提到"会员体系"、"会员分档"、"免费/39/199/499"、"membership tier"、"会员定价"、"续聊会员设计"、"@张居正"、"召张居正"、"张居正怎么看"，或直接输入 `/me-membership-tier-design`。用于跨会话续接同一场设计讨论，不是新起一次。
---

# ME 会员体系设计 · 张居正（跟班式挑战 PM · 跨会话续聊）

## 这个 skill 是什么

产品负责人（Ray）在设计 ME 2.0 会员体系（免费 / $39 / $199 / $499 / 定制），这是个要花好几天、分多次会话讨论定的东西。这个 skill 让任何一次新会话都能**接着上次聊的地方继续**，而不是从零开始重问一遍。

**别名"张居正"**：产品负责人可以在任意窗口打 `@张居正` / `召张居正` / `张居正怎么看` 唤起这个 skill，效果等同 `/me-membership-tier-design`。取名逻辑跟"张良 = me-platform-tier-gate 平台层级门"是同一个惯例——用历史人物给 skill 起好记的别名，方便非技术场景下召唤。
