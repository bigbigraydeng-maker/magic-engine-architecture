/**
 * WP05 GEO Module v1 —— Roman 真实基线**只读**诊断（Issue #879）
 *
 * ═══════════════════════════════════════════════════════════════════════════
...
function main(): void {
  ...
  Promise.resolve()
    .then(async () => {
      line('══════════════════════════════════════════════════════════════════')
      line('WP05 GEO Module v1 —— Roman 真实基线只读诊断')
      line(`client_id=${ROMAN_CLIENT_ID}  batch=${ROMAN_BATCH_ID}`)
