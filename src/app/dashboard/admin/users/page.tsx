...
export default function UserConsolePage() {
  ...
  return (
    <div className="p-8 max-w-6xl">
      <div className="mb-6">
        <h1 className="font-display text-2xl font-bold tracking-tight text-me-charcoal/90">User Console</h1>
          ...
          {TABS.map(tab => (
            <button
              ...
              className={`flex items-center gap-2 px-4 py-2.5 text-sm font-medium rounded-t-lg border-b-2 transition-colors ${
                activeTab === tab
                  ? 'border-me-ochre text-me-ochre bg-me-ochre/10'
                  : 'border-transparent text-me-charcoal/55 hover:text-me-charcoal/75 hover:bg-me-ivory'
              }`}
            >
