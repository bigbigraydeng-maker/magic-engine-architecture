...
import { MailchimpAudiencePanel } from './_components/MailchimpAudiencePanel'
    ...
    case 'crm':
      return (
        <>
          ...
          <SettingsSection icon="📮" title="Meta 广告线索送进哪个 Mailchimp 名单">
            <MailchimpAudiencePanel clientId={clientId} />
          </SettingsSection>
