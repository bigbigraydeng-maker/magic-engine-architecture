  ...
  return (
    <div className="relative">
      ...
      <div className="absolute inset-0 flex items-start justify-center pt-16">
        <div className="mx-4 w-full max-w-md rounded-xl border border-amber-200 bg-amber-50 p-6 shadow-lg">
          ...
          <Link
            ...
            className="mt-4 inline-flex h-10 items-center rounded-lg bg-amber-500 px-4 text-sm font-bold text-white hover:bg-amber-600"
          >
            Complete brief →
          </Link>
        </div>
