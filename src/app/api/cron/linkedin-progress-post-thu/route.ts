/**
 * GET /api/cron/linkedin-progress-post-thu
 *
 * Thursday half of the weekly ME-product-progress → LinkedIn pipeline. See
 * src/lib/linkedin-progress/run.ts for the full behaviour — this file only
 * exists so 'linkedin-progress-post-thu' is independently visible in
...
export async function GET(req: NextRequest) {
  ...
  const cronRun = await startCronRun('linkedin-progress-post-thu')
