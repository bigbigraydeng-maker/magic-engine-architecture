...
| ~~待批准草稿 UI（三按钮）~~ | #1588 | [#1751](https://github.com/bigbigraydeng-maker/magic-engine/pull/1751)（已合并，merge commit `61804a37`，`[#1588]`） | ✅ 已完成 |
...
> **本次核实（2026-09-15 UTC ~10:22，这份表格改了好几轮的原因就是这条线并行窗口多、状态几分钟就变一次，
> 每次改完都建议再核实一遍再提交）**：9 个里 **4 个已 CLOSED**（#1584 经 PR #1739、#1586 经 PR #1741、
> #1588 经 PR #1751、#1589 经 PR #1747，均已合并）；其余 5 个（#1585/#1587/#1590/#1591/#1592）仍是 `OPEN`
> 且搜索无匹配 PR（#1585/#1592 的搜索命中过其它无关 PR，已人工核对标题排除，不是真的实现 PR），状态是真的
