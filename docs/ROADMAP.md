...
- [ ] 🔴 **M2.7i 让解析器读到那 90% 的对话** —— **这是阶段能自动填上的前提**。
      ...
      只靠现在这 10% 能认出约 125 人（已付定金 18 / 已报价 67 / 说了出行时间 14 / 明确不要 26）。
      已上抛 PM 确认方向
...
- [ ] **M2.7l 🙋 需要你动手：1 个客人可能被误标成「永久别再联系」** ——
      **what**：旧词表把「不打算去」当成了「别再联系」。线上 13 个被永久拉黑的人里，
      8 个原话确实划过界限，**1 个只因为「不打算去」**。新写的备注不会再落这个坑，
      但存量这一个需要人看一眼 —— **不做自动解除**：那个标记的含义是「任何渠道都不许
      再发」，让正则去解开它，万一原话里同时有真拒绝，就会骚扰一个明确说过别联系的客人。
      **how**：调出他的时间线看原话，确认只是「不打算去」而不是「别再联系」，
      再在客户档案里取消勾选。**href**：CRM →「全部客人」→ 该联系人 → 时间线
