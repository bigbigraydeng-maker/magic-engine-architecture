...
模板判据**锚在消息开头且主语必须是「我」**——「my friend filled out the form」
不算，那是转发同行者资料最自然的说法，认了就把**别人的号码**写进这个人的档案。
...
**已登记、没做**：逐联系人串行查询改批量 · 给「试过补不上」的人打标 ·
解绑 Facebook 主页的客户跑不到本地回填 · 只留电话时按电话认人（会多一条重复
联系人，但不会把错号码写进别人档案）。四条同源 —— **补档案与认亲该有自己的
一轮设计**，不该继续在同步链路里加分支。
